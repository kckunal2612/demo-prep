...
description: >
  ...
  Asks what to focus on, who the audience is, and how much effort to spend,
  then generates a tailored .pptx presentation. Use when the user says "prep
  my demo", "make a demo deck", "what did I ship", "generate a presentation
  of my work", or invokes /demo-prep. Also triggers when an engineer needs to
  summarize recent work for a meeting, sprint review, or engineering
  all-hands.
